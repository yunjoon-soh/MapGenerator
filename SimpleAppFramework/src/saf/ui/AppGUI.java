...
public class AppGUI implements AppStyleArbiter {
	...
	// AND NOW SETUP THEIR EVENT HANDLERS
        ...
        // ADD fileToolbarPane to topToolbarPane;
        topToolbarPane.getChildren().add(fileToolbarPane);
    }
    ...
    public HBox getFileToolbarPane(){
    ...
    public Button initChildButton(Pane toolbar, String icon, String tooltip, boolean disabled) {
        int pos = toolbar.getChildren().size();
        return initChildButton(toolbar, icon, tooltip, disabled, pos);
    }
     ...
     * pane container.
     */
    public static Button initChildButton(Pane toolbar, String icon, String tooltip, boolean disabled, int pos) {
        if(pos < 0)
            return null;
	...
	// PUT THE BUTTON IN THE TOOLBAR
        toolbar.getChildren().add(pos, button);
    ...
    public double getTopToolBarHeight(){
        return topToolbarPane.getHeight();
    }
	...
	topToolbarPane.getStyleClass().add(CLASS_BORDERED_PANE);
        fileToolbarPane.getStyleClass().add(CLASS_TOOLBAR_PANE);
