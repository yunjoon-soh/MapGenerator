...
public class JClassDesigner extends AppTemplate {
    ...
    public AppComponentsBuilder makeAppBuilderHook() {
        return new AppComponentsBuilder() {
             ...
             *
             * @return The component that will manage all data updating for this
             * application.
             *
             * @throws Exception An exception may be thrown should data updating
             * fail, which can then be customly handled.
             */
            @Override
             ...
             *
             * @return The component that will manage all file I/O for this
             * application.
             *
             * @throws Exception An exception may be thrown should file I/O
             * updating fail, which can then be customly handled.
             */
            @Override
             ...
             *
             * @return The component that serve as the workspace region of the
             * User Interface, managing all controls therein.
             *
             * @throws Exception An exception may be thrown should UI updating
             * fail, which can then be customly handled.
             */
            @Override
     ...
     * inherited from AppTemplate, defined in the SimpleAppFramework.
     */
